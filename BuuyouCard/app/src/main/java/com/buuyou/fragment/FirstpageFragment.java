...
public class FirstpageFragment extends Fragment {
    ...
    TextView tv_fragmentfirstpage_id0,tv_fragmentfirstpage_pwd0,tv_fragmentfirstpage_lastlogin0;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        tv_fragmentfirstpage_pwd0=(TextView)view.findViewById(R.id.tv_fragmentfirstpage_pwd0);
        tv_fragmentfirstpage_lastlogin0=(TextView)view.findViewById(R.id.tv_fragmentfirstpage_lastlogin0);
        sp=getActivity().getSharedPreferences("data",Context.MODE_PRIVATE);
        tv_fragmentfirstpage_id0.setText(sp.getString("userid", null));
        tv_fragmentfirstpage_pwd0.setText(sp.getString("checkCode",null));
